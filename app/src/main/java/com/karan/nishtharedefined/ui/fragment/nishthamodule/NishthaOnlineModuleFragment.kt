...
class NishthaOnlineModuleFragment : Fragment(), ModuleAdapter.OnModuleClickedListener {

    private lateinit var bindingNishthaModule: NishthaModuleFragmentBinding
    private val nishthaOnlineViewModel by lazy {
        val app = requireNotNull(activity?.application)
        ViewModelProvider(this, NishthaOnlineViewModel.Factory(app))
            .get(NishthaOnlineViewModel::class.java)
    }
